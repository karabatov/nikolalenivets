...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    for (int i = 0; i < self.folds; i++) {
        ...
        leftToViewFold.layer.position = CGPointMake(self.reverse ? size.width + offset : -size.width + offset, size.height / 2);
        ...
        rightToViewFold.layer.position = CGPointMake(self.reverse ? size.width + offset + foldWidth * 2: -size.width + offset + foldWidth * 2, size.height / 2);
